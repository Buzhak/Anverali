...
class TestIndexView:
    ...
    def test_index_view_anonim_or_customer_get(
        self, client, customer_1_client, hwork_1, hwork_2, hwork_3
    ):
    ...
    @pytest.mark.django_db(transaction=True)
    def test_index_view_seller_get(
        self,
        seller_1,
        seller_1_client,
        hwork_1,
        ...
        orders = Order.objects.filter(
            is_finished=False, seller=seller_1.get_username()
        ).all()
        for order in orders:
